...
const CustomServiceConfiguration = (props) => {
	return (
		<section>
			...
			<p>Select a requesting service and responding service from the drop-down menus below.  If a custom configuration already exists for the pair, it will be displayed in the text input below.</p>
